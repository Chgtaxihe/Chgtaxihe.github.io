...
<el-collapse>
<el-collapse-item title="AVL树代码" name="1">
...
public class AVLTree<T extends Comparable<T>> implements Tree<T>{
    ...
    private static class AVLNode<T> {
        ...
        private AVLNode<T>[] child = new AVLNode[2];
        private T value;
...
<el-collapse-item title="测试代码" name="2">
...
参考资料：https://en.wikipedia.org/wiki/AVL_tree
...
<el-collapse>
<el-collapse-item title="B树代码" name="1">
...
public class BTree<K extends Comparable<K>> implements Tree<K> {
    ...
    public BTree(int order) {
        maxChildrenSize = order;
        minChildrenSize = (order + 1) / 2;
        maxKeySize = maxChildrenSize - 1;
        minKeySize = minChildrenSize - 1;
        root = new Node<>(null);
    }
    ...
    private class Node<K extends Comparable<K>> {
        ...
        private Node<K>[] children = new Node[maxChildrenSize + 1];
